      ...
      <div className="about-us">
        <div className="content-about" data-aos="zoom-in">
          ...
          <p>
            ...
            eaque totam. Quidem, perferendis aspernatur similique deserunt reprehenderit
            error ab! Eveniet a voluptatibus corrupti. Lorem ipsum dolor sit amet
        ...
        <div className="img-about" data-aos="zoom-in"></div>
      </div>
        ...
        <div className="call-about">
          <div className="call-ablot-phone">
            ...
            <div className="telephones">
              <span>+243 825 910 778 </span>|<span> +243 810 671 668</span>
            </div>
          </div>
        </div>
      </div>
